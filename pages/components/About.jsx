...
const About = () => {
  return (
    <div
      id='about'
      className='w-full md:h-screen p-2 flex items-center py-16 bg-white text-gray-800 scroll-mt-14'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-1 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-4 text-gray-600 max-w-[90%] m-auto text-xl leading-9 text-justify'>
            I care about the stuff users actually feel, such as speed, clarity,
            and flows that just make sense. That means keeping Core Web Vitals
            in check, making sure accessibility is built in, and building
            components that are clean, reusable, and easy to grow over time.
          </p>
          <p className='py-4 text-gray-600 max-w-[90%] m-auto text-xl leading-9 text-justify'>
